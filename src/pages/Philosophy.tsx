    ...
    <main id="top" className="pt-20">
      ...
      <section className="section-padding">
        <div className="max-w-[700px] mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-display">What We Believe</h2>
        ...
        <div className="max-w-[700px] mx-auto px-6 text-center">
          ...
          <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed text-[17px]">
            ...
            <p>
              ...
              this is overpriced bullshit, tell us—we'd rather have an honest conversation than a refund request.
            </p>
            <p>
