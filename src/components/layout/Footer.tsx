        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm font-body text-primary-foreground/70 max-w-sm leading-relaxed">
              Field Oil is a daily face oil for men whose days are hard on the skin. One product. Sixty seconds. Maintains what sun, salt, wind, and time wear down.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link to="/field-notes" className="text-sm font-body text-primary-foreground/70 hover:text-primary-foreground transition-colors">
                Field Notes
              </Link>
