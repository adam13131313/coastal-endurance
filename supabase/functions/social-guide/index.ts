...
const SECTIONS = [
  ...
  { sub: "Current formula (100% natural)" },
  { p: "Rosehip and Hemp (active oils); Australian Jojoba and Macadamia (carrier oils); Meadowfoam, Vitamin E, and Rosemary (natural antioxidant system). 100% natural, no synthetics." },
  { note: { title: "Confirm the current details before publishing", items: [
    "**“100% natural” is approved.** Field Oil is 100% natural (no synthetics) and is a cosmetic, not a therapeutic good — use the claim with confidence.",
